                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="kechengName" id="kechengName" placeholder="资源标题" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                    ...
                    <div class="travel-gallery-wrapper">
                        <div class="row">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 col-lg-3 single-box">
                                ...
                                <div @click="jumpCheck('../kecheng/detail.jsp?id='+item.kechengId , item.kechengDelete == null?'':item.kechengDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="part-img">
                                        <img :src="item.kechengPhoto?item.kechengPhoto.split(',')[0]:''" style="height: 350px;width:100%;">
                                    </div>
                                    <div class="part-txt" style="margin-top: 5%;height:95%;">
