    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in newsList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
                                <a @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="lsb-preview" data-lsb-group="header">
                                    <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                    <div class="agileits-caption">
                                        <h4>{{item.newsName}}</h4>
                                        <p v-if="item.newsNewMoney != null" >￥{{item.newsNewMoney}}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in kechengList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
                                <a @click="jumpCheck('../kecheng/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="lsb-preview" data-lsb-group="header">
                                    <img :src="item.kechengPhoto?item.kechengPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                    <div class="agileits-caption">
                                        <h4>{{item.kechengName}}</h4>
                                        <p v-if="item.kechengNewMoney != null" >￥{{item.kechengNewMoney}}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
